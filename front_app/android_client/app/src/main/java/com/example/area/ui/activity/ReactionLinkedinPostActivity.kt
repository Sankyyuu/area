...
class ReactionLinkedinPostActivity : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_reaction_linkedin_post)
    }
    ...
    fun createArea (view: View) {
        ...
        rootObject.put("name", "linkedin_post")
        rootObject.put("post", message.text.toString())
