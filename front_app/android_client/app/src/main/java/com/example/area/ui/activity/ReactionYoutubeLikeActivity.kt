...
class ReactionYoutubeLikeActivity : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_reaction_youtube_like)
    }

    fun createArea (view: View) {
        val message = this.findViewById<EditText>(R.id.channelName)
        ...
        rootObject.put("name", "youtube_like")
        rootObject.put("channelName", message.text.toString())
