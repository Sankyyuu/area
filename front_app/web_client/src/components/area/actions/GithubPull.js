...
class GithubPull extends React.Component {
	...
	handleOwner = async (e) => {
		...
		this.props.updateData({name: "github_pull", owner: this.state.owner, repo: this.state.repository})
	}
