...
class GithubPush extends React.Component {
	...
	handleOwner = async (e) => {
		...
		this.props.updateData({name: "github_push", owner: this.state.owner, repo: this.state.repository})
	}
